...
import com.sun.library.http.net.load.download.DownloadInterceptor;
import com.sun.library.http.net.load.download.DownloadObserver;
import com.sun.library.http.net.model.Download;
import com.sun.library.http.net.retrofit.RetrofitUtils;
import com.sun.library.http.net.utils.ComputeUtils;
import com.sun.library.http.net.utils.DBHelper;
import com.sun.library.http.net.utils.HttpLogUtils;
import com.sun.library.http.net.utils.RequestUtils;
import com.sun.library.http.net.utils.ResponseUtils;
...
public class RDownLoad {
    ...
    public void startDownload(final Download download) {
        ...
        HttpLogUtils.d("RHttp startDownload:" + download.getServerUrl());
        /*判断本地文件是否存在*/
        ...
        Map<String, Object> headerMap = SunHttp.Configure.get().getBaseHeader();
    ...
    public void stopDownload(Download download) {
        ...
        HttpLogUtils.d("RHttp stopDownload:" + download.getServerUrl());
        /**
         * 1.暂停网络数据
         * 2.设置数据状态
         * 3.更新数据库
    ...
    public void removeDownload(Download download, boolean removeFile) {
        ...
        HttpLogUtils.d("RHttp removeDownload:" + download.getServerUrl());
        //未完成下载时,暂停再移除
    ...
    public void stopAllDownload() {
        ...
        callbackMap.clear();
        downloadSet.clear();
        HttpLogUtils.d("RHttp stopAllDownload");
    }
